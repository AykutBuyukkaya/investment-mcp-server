...
class FakeGoldClient:
    ...
    async def get_history(
        ...
        *,
        ...
        return [
            GoldHistoricalBar(date="2026-04-20", open=6200.0, high=6250.0, low=6190.0, close=6240.0),
            GoldHistoricalBar(date="2026-04-21", open=6240.0, high=6300.0, low=6230.0, close=6290.0),
            GoldHistoricalBar(date="2026-04-22", open=6290.0, high=6340.0, low=6280.0, close=6320.0),
        ]
