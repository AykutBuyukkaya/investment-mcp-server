...
- `get_customer_portfolio`: fetches the customer's current dummy portfolio from the backend service at `/api/portfolio`. Configure the backend origin with `PORTFOLIO_BACKEND_BASE_URL`, defaulting to `http://178.105.68.111:6767`.
